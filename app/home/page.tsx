...
const WEEKS = [
  { week: 1,  topic: 'Orientation: Recording My Media Life',       phase: 'Individual' },
  { week: 2,  topic: 'Building Good Media Data',                    phase: 'Individual' },
  { week: 3,  topic: 'Visualizing My Daily Life',                   phase: 'Individual' },
  { week: 4,  topic: 'Designing My Personal Probe',                 phase: 'Individual' },
  { week: 5,  topic: 'Machine Learning Blueprint',                  phase: 'Individual' },
  { week: 6,  topic: 'Regression: What Affects My State?',         phase: 'Individual' },
  { week: 7,  topic: 'Classification: Labeling My Days',           phase: 'Individual→Team' },
  { week: 8,  topic: 'Clustering: Finding My Life Modes',          phase: 'Team Prep' },
  { week: 9,  topic: 'Apriori & Team Kick-off',                    phase: 'Team' },
  { week: 10, topic: 'From Individual to Class',                   phase: 'Team' },
  { week: 11, topic: 'Same Situation, Different Responses',        phase: 'Team' },
  { week: 12, topic: 'Data Freeze & Comparison Prep',             phase: 'Team' },
  { week: 13, topic: 'Class vs. KISDI Media Panel',               phase: 'Team' },
  { week: 14, topic: 'Building the Human-Centered Dashboard',      phase: 'Team' },
  { week: 15, topic: 'Final Presentation',                         phase: 'Final' },
]
      ...
      {isProfileTab ? (
        ...
        <main className="max-w-2xl mx-auto px-4 py-8 space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">SKKU · 2026 Fall · Prof. Changjun Lee</p>
          </div>
          ...
          {currentWeek === 0 ? (
            <Card className="border-blue-200 bg-blue-50">
              <CardContent className="py-4">
                <p className="text-sm font-medium text-blue-800">
                  Semester starts September 1, 2026
                </p>
                <p className="text-xs text-blue-600 mt-1">
                  Start logging your daily data from Day 1!
                </p>
              </CardContent>
            </Card>
          ) : (
            <Card className="border-blue-200 ring-1 ring-blue-200">
              <CardHeader className="pb-1">
                <p className="text-xs text-blue-600 font-medium uppercase tracking-wide">This Week</p>
              </CardHeader>
              <CardContent>
                <p className="font-semibold">Week {currentWeek} · {WEEKS[currentWeek - 1].topic}</p>
                <Badge className={`mt-2 text-xs ${PHASE_COLOR[WEEKS[currentWeek - 1].phase]}`}>
                  {WEEKS[currentWeek - 1].phase}
                </Badge>
              </CardContent>
            </Card>
          )}
